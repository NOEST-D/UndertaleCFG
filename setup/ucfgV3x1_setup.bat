...
if "%op%"=="1" (
	...
	echo.
	echo Invalid operation! Enter "1", "2", or "3"!
...
echo powershell -Command "Expand-Archive -Path '%instDIR%\ucfgV3x1.zip' -DestinationPath '%instDIR%' -Force"
...
:UNINSTALL
echo Removing UndertaleCFG directory...
echo rmdir "%instDIR%"
rmdir /S /Q "%instDIR%"
echo Done.
echo.
